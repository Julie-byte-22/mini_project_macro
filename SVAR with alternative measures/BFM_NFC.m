...
%%% Baseline SVAR - Non-financial Corporate Sector
...
%% Importing the data - Nonfinancial Corporate Sector (except CNP16OV):

[data,header]=xlsread('BFM_data.xlsx','NONFINANCIAL CORPORATE','B145:R288');
...
%% IRFs and VD for the third row of Figure 11:
