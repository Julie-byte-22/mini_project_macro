...
%%% Baseline SVAR - Second row of Figure 12
...
ylevel=[log(Output./CNP16OV)*100, log(Wages)*100, log(Hours./CNP16OV)*100, log((Profits)./CNP16OV)*100, log(Investment./CNP16OV)*100];
...
%% IRFs and variance decomposition - Second row of Figure 12:

% Setup:

conf=68; % confidence level
colorBNDS=[0.7 0.7 0.7]; % color of the bands
VARnames={'GDP'; 'WAGES'; 'HOURS';'PROFITS';'INVESTMENT';'LABOR SHARE'}; % variable names
irf.figtit.shock = { ...
